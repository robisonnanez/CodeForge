                    ...
                    <div className="hidden flex-col justify-between bg-[radial-gradient(circle_at_top,_#2f3b75,_#151b3b)] p-10 lg:flex">
                        ...
                        <div>
                            ...
                            <p className="mt-3 text-slate-300">
                                Sign in to continue managing modules,
                                permissions, and your dashboard.
                            </p>
                        </div>
                    </div>
                                ...
                                <>
                                    <div>
                                        ...
                                        <input
                                            name="email"
                                            type="email"
                                            className="w-full rounded-lg border border-white/10 bg-[#2a325d] px-3 py-2 text-white ring-0 outline-none placeholder:text-slate-400 focus:border-fuchsia-400"
                                    ...
                                    <div className="flex items-center justify-between gap-3">
                                        <label className="flex items-center gap-2 text-sm text-slate-300">
                                            <input
                                                ...
                                                value="1"
                                                type="checkbox"
                                                className="h-4 w-4 rounded border border-white/20 bg-[#2a325d]"
                                            />
                                            Remember me
                                        </label>
                                        {canResetPassword && (
                                    ...
                                    <button
                                        type="submit"
                                        disabled={processing}
                                        className="w-full rounded-lg bg-fuchsia-500 px-4 py-2.5 font-semibold text-white transition hover:bg-fuchsia-400 disabled:cursor-not-allowed disabled:opacity-60"
                                    >
                                        {processing
                                            ? 'Signing in...'
                                            : 'Sign in'}
